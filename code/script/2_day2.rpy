label day_two:
    ...
    "Jun wakes to a shrill cry piercing through the early morning silence."

    "On the same day she'd decided the thrashing and gnashing of teeth would do her no good, these shrieks replaced her. "

    "She can never quite make anything out, the message being lost in translation given the arduous task of having to penetrate several inches of wood before reaching her."

    "Luckily, her larger than average ears provide her with a few fleeting pieces of insight into the conversation."
    ...
    "Despite this, she feels the desire to dig in, and she takes a private moment to remind herself of all the more pleasant ways she could satiate her cravings. "

    "She recalls a letter she'd penned to a recently made friend after he lamented needing to familiarize himself with meat when traveling to places where more vegetarian diets were less easy to accommodate. "

    "In response, she had invited the harengon to come with her to sample a specific selection from a restaurant that had catered to her family at a banquet many moons ago. "

    "While yes, the aspects of the meal the two took pleasure in were drastically different, it was a practical enough suggestion that she didn't feel like a schoolchild begging to play. "
    ...
    "With the introduction of alliances with magical folk, the mortals gained an actual fighting chance beyond being a slightly inconvenient hunt."

    "However, the allure of their blood and the vast amount of it, especially when well-kept and well tended to, kept vampires coming back for more."

    "So much so that when visiting her less fortunate relatives, if they had a human in their possession, it was not uncommon to see them being kept alive just enough to continue siphoning off their blood for a longer time."
    ...
    "Following an imaginary path from its tail to its gangly limbs to its distinctive snout, a revolting picture was painted. "
    ...
    "Astrid's apathy to the sorry sight stirred something within, unearthing an event from her past she preferred to keep buried six feet deep in the rubble."

    "Had she not chosen the path of a lone wolf once, going against the plans set out for her and fleeing the safety of the castle?"

    "Fueled by anger, arrogance, and a powerful determination, she swore she'd do all she could to make them regret not choosing her. "

    "It was the entire reason she had settled on that charming little village, so isolated from the rest of civilization that barely anyone would notice if she picked off a person or two. "

    "She hadn't intended to get that carried away. Her true objective had always been to infiltrate and find the individual with the most sway and influence."

    "With a bit of mind control and persuasion, she'd be able to turn everyone there, and soon enough she'd be marching an undead army back to her home to show just how capable she is of leading. "

    "Reality was far less kind than her imagination. She would never live to wipe that smile off of her brother's face. She would die proving her mother's doubts right, drowning in regrets of what could've been."
    ...
    "Now she is Astrid leering down. She is digging her own grave, but not without taking others with her. "

    "In a strange way, Jun can see Astrid's point of view. What right did anyone else have to belong when she could not? "
...
label day_two_cont:
    ...
    "Groggily, she sat back upright, grumbling some complaint that is lost amidst Astrid's heaving gasps."

    "Jun tries to locate Astrid in the darkness, something that shouldn't be difficult at all given her night vision and the wolfkin's hulking frame."
    ...
    a "I was tasked with infiltrating a tribe of wolfkin the hunters had found a few months before. "

    a "The mission was simple enough. Build trust with the tribe, learn their secrets, send it back to base, and when the time is right, ambush the tribe when they least expect it. Leave no survivors. "

    a "The plan went off without a hitch. I slipped into the village without suspicion, and earned the trust of each villager with relative ease. It took 2 months to plan out the attack, stripping them of their means of defense."
    ...
    a "Chasing her out into the woods, I could hear the pitter-patter of her little feet and the sound of her pants as she desperately tried to get away from me."
    ...
    a "A piece of me can't help but feel guilt for the damage. "
    ...
    "An attack dog made of porcelain, poised to be broken and built back up in a better image. "
    ...
    "Actually, she found she didn't quite mind it. "

    "Like this, their goals aligned. Astrid didn't want to change, so why should she force it? "
    ...
    "When an invention goes wrong, who else is to blame but the creator?"

    "Mother, father, brother. Relatives and family friends and guests. Snakes in the grass of a heavenly garden preying on her downfall. All of them would get their comeuppance. All of them would pay the toll."
    ...
    "A million questions rotated through her brain. Why a kiss? "

    "Was it a trick? A creative new mockery that would laugh in her face for trusting its sweetness? "
