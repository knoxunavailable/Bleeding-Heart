label day_one:
    ...
    show astrid idle neutral at topright
    show jun idle2 disgust neutral at cleft
    ...
    show jun idle2 disgust neutral
    show astrid idle
    ...
    y "{i}YOU.{cps=2} {/cps}ARE.{cps=2} {/cps}S C U M.{/i}"

    scene bgdungeon
    show jun idle2 shocked at cleft
    show astrid ashamed neutral at topright
    ...
    show astrid idle frown
    show jun idle2 idgaf

    "She {i}almost{/i} looks frightening."

    y @ talk "...The barbarity you dress up as valor is what led to your inevitable capture. Soon enough, your brethren shall join you in your fate. I cannot wait to see them in the same cell you sit in."

    y @ talk "You should consider yourself blessed to be chosen by the Highmother for such a high honor. Your death is the least you could give to the world after decades of chaos and bloodshed."
    ...
    a @ talk "And why exactly does it matter who {i}I{/i} am. I am merely the hand of the Highmother. If you wish to curse a name, Her is there to utter." 

    show astrid idle outis 

    a "In fact, I {i}call{/i} upon it. A curse uttered from {i}your{/i} mouth is an equivalent to a {i}blessing{/i} from the gods above." 
    ...
    scene bgdungeon
    show jun idle shiteating3 at cleft
    show astrid shocked at topright
    ...
    a @ talk "...You're a {i}perceptive{/i} one, aren't you."
    ...
    a @ talk "You seem awfully proud of yourself. I suppose it makes sense to celebrate the small victories when your defeat is practically assured."
    ...
    j "{cps=2} {/cps}.{cps=2} {/cps}.{cps=2} {/cps}."
    ...
    j "Still, if we're going to run with that argument, what about {i}your{/i} pack?"
    ...
    hide astrid ashamed talk with easeoutright
